...
echo "Portal Launch - In Healthcheck Worker $SERVICE_NAME config path: $DIST_CONFIG_PATH"
echo "Portal Launch - In Healthcheck Worker IB_DEV: $IBDEV_STR"
...
echo "The health check has been finised in the worker nodes."
